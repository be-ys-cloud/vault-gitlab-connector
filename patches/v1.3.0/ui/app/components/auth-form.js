...
const DEFAULT_TYPE = get(BACKENDS.reduce((r, b) => r ? Ember.get(b, 'default') ? b : r : b), 'type');
...
export default Component.extend(DEFAULTS, {
    ...
    methodsToShow: computed('methods', function() {
        ...
        if (shownMethods.length < 1) {
            shownMethods = shownMethods.concat(BACKENDS);
        }
        shownMethods = shownMethods.sort((a, b) => (1 / get(b, 'showOrder') || 0) - (1 / get(a, 'showOrder') || 0))
        return shownMethods;
    }),
